            ...
            <div class="navbar-nav flex-row order-md-last">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <inertia-link :href="route('admin.settings.index')" class="dropdown-item">
                            <adjustments-icon  class="dropdown-item-icon"></adjustments-icon>
                            Sistem Ayarları
                        </inertia-link>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                    <ul class="navbar-nav">
                        ...
                        <nav-bar-link tag="camera.index"
                                      active="camera.">
                                 <span class="nav-link-icon d-md-none d-lg-inline-block">
                                     <device-computer-camera-icon></device-computer-camera-icon>
                                </span>
                            <span class="nav-link-title">
                                  Kameralar
                                </span>
                        </nav-bar-link>
                        <nav-bar-link tag="admin.settings.index"
